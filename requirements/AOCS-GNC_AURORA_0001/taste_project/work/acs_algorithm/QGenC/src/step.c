   ...
   Step_State* const State)
{
   ...
   for (i = 0; i <= 4; i++) {
      time_out1[i] = (GASINGLE) (Tmp[i] / 5.0E+00);
   }
   ...
   for (i = 0; i <= 14; i++) {
      Cast_To_Single_out1[i] = (GASINGLE) BBT->arr[i];
   }
   ...
   for (i = 0; i <= 4; i++) {
      time_1_out1[i] = (GASINGLE) (Tmp_1[i] / 5.0E+00);
   }
   ...
   for (i = 0; i <= 4; i++) {
      time_2_out1[i] = (GASINGLE) (Tmp_2[i] / 5.0E+00);
   }
   ...
   for (i = 0; i <= 2; i++) {
      Cast_To_Single1_out1[i] = (GASINGLE) Omega->arr[i];
   }
   ...
   for (i = 0; i <= 2; i++) {
      Cast_To_Single5_out1[i] = (GASINGLE) MT_Working->arr[i];
   }
   ...
   /* Block 'Step/ACS_Algorithm/If Fail Recalculate/Noone Fails1' */
   if ((GAUINT8) (Cast_To_Single5_out1[0] + Cast_To_Single5_out1[1] + Cast_To_Single5_out1[2] == 3.0E+00) > 0) {
      State->Noone_Fails1_enabled = GATRUE;
   ...
   /* Block 'Step/ACS_Algorithm/If Fail Recalculate/1 Fail' */
   if ((GAUINT8) (Cast_To_Single5_out1[0] + Cast_To_Single5_out1[1] + Cast_To_Single5_out1[2] == 2.0E+00) > 0) {
      State->q_1_Fail_enabled = GATRUE;
   ...
   /* Block 'Step/ACS_Algorithm/If Fail Recalculate/2 Fails' */
   if ((GAUINT8) (Cast_To_Single5_out1[0] + Cast_To_Single5_out1[1] + Cast_To_Single5_out1[2] == 1.0E+00) > 0) {
      State->q_2_Fails_enabled = GATRUE;
   ...
   for (i = 0; i <= 2; i++) {
      Control_T_Control_BusCre_out1.arr[i] = (GAREAL) Product_2_out1[i];
   }
