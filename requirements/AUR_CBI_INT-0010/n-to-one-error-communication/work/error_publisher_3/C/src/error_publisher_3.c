/* Body file for function Error_publisher_3
...
asn1SccT_ErrorMessage error_publisher_3_buildError(asn1SccPID functionPid)
{
    uint64_t seconds = 0;
...
void error_publisher_3_startup(void)
{
    srand((unsigned int)time(NULL));
}

void error_publisher_3_PI_trigger3(void)
{
    asn1SccT_ErrorMessage errorMessage = error_publisher_3_buildError(PID_error_publisher_3);

    error_publisher_3_RI_Error_send(&errorMessage);
}
