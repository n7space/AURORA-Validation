...
set_param('Iface/input','BusObject','MySeqOf');
add_block('simulink/Commonly Used Blocks/Bus Selector','Iface/input_MySeqOf_BusSel');
add_line('Iface','input/1','input_MySeqOf_BusSel/1');
setOutputsBusSelector(MySeqOf, 'Iface/input_MySeqOf_BusSel');
if all_inports_created
   set_param('Iface/input_MySeqOf_BusSel','Position', bussel_positions(inport_index,:));
else
   set_param('Iface/input_MySeqOf_BusSel','Position',[95 ((inport_index * 100) - 19) 100 ((inport_index * 100) + 19)]);
end
...
set_param('Iface/output','BusObject','MySeqOf');
add_block('simulink/Commonly Used Blocks/Bus Creator','Iface/output_MySeqOf_BusCre');
add_line('Iface','output_MySeqOf_BusCre/1','output/1');
setInputsBusCreator(MySeqOf,'Iface/output_MySeqOf_BusCre');
set_param('Iface/output','UseBusObject','on');
set_param('Iface/output','BusOutputAsStruct','on');
 set_param('Iface/output_MySeqOf_BusCre','BusObject','MySeqOf');
if all_outports_created
   set_param('Iface/output_MySeqOf_BusCre','Position', buscre_positions(outport_index,:));
else
   set_param('Iface/output_MySeqOf_BusCre','Position',[360 ((outport_index * 100) - 19) 365 ((outport_index * 100) + 19)]);
end
set_param('Iface/output_MySeqOf_BusCre','UseBusObject','on');
set_param('Iface/output_MySeqOf_BusCre','NonVirtualBus','on');
