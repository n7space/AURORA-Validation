...
set_param('Iface/input','BusObject','MyIA5String');
add_block('simulink/Commonly Used Blocks/Bus Selector','Iface/input_MyIA5String_BusSel');
add_line('Iface','input/1','input_MyIA5String_BusSel/1');
setOutputsBusSelector(MyIA5String, 'Iface/input_MyIA5String_BusSel');
if all_inports_created
   set_param('Iface/input_MyIA5String_BusSel','Position', bussel_positions(inport_index,:));
else
   set_param('Iface/input_MyIA5String_BusSel','Position',[95 ((inport_index * 100) - 19) 100 ((inport_index * 100) + 19)]);
end
...
set_param('Iface/output','BusObject','MyIA5String');
add_block('simulink/Commonly Used Blocks/Bus Creator','Iface/output_MyIA5String_BusCre');
add_line('Iface','output_MyIA5String_BusCre/1','output/1');
setInputsBusCreator(MyIA5String,'Iface/output_MyIA5String_BusCre');
set_param('Iface/output','UseBusObject','on');
set_param('Iface/output','BusOutputAsStruct','on');
 set_param('Iface/output_MyIA5String_BusCre','BusObject','MyIA5String');
if all_outports_created
   set_param('Iface/output_MyIA5String_BusCre','Position', buscre_positions(outport_index,:));
else
   set_param('Iface/output_MyIA5String_BusCre','Position',[360 ((outport_index * 100) - 19) 365 ((outport_index * 100) + 19)]);
end
set_param('Iface/output_MyIA5String_BusCre','UseBusObject','on');
set_param('Iface/output_MyIA5String_BusCre','NonVirtualBus','on');
