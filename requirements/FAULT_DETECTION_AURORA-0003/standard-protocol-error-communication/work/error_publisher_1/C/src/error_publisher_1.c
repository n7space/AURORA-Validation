/* Body file for function Error_publisher_1
...
asn1SccT_ErrorMessage error_publisher_1_buildError(asn1SccPID functionPid)
{
    uint64_t seconds = 0;
...
void error_publisher_1_startup(void)
{
    srand((unsigned int)time(NULL));
}

void error_publisher_1_PI_trigger1(void)
{
    asn1SccT_ErrorMessage errorMessage = error_publisher_1_buildError(PID_error_publisher_1);

    error_publisher_1_RI_Error_send(&errorMessage);
}
